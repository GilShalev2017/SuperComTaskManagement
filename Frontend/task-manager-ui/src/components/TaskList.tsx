          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell onClick={() => requestSort("priority")} sx={{ cursor: "pointer" }}>
                  Priority
                </TableCell>
              ...
              {sortedTasks.map(task => {
                ...
                return (
                  <TableRow key={task.id} hover>
                    ...
                    <TableCell>{overdue ? "Overdue" : "Future"}</TableCell>
                  </TableRow>
                );
              })}
            </TableBody>
        ...
        <Box sx={{ display: "flex", gap: 1, flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          >
            <ToggleButton
              value="cards"
              // sx={{
              //   color: viewMode === 'cards' ? '#1976d2' : 'inherit', // bluish when selected
              // }}
              >
            ...
            <ToggleButton
              value="table"
              // sx={{
              //   color: viewMode === 'table' ? '#1976d2' : 'inherit', // bluish when selected
              // }}
              >
